...
int resizeUp(ArrayList* this)
{
    ...
    aux = (void**) realloc(this->pElements,sizeof(this->pElements)*(this->size+AL_INCREMENT));
...
/** \brief Decrements the number of elements in pList in AL_INCREMENT elements.
 * \param pList ArrayList* Pointer to arrayList
 * \return int Return (-1) if Error [pList is NULL pointer or if can't allocate memory]
 *                  - (0) if ok
 */
int resizeDown(ArrayList* this)
{
    ...
    {
        this->pElements = (void**) realloc(this->pElements,sizeof(this->pElements)*(((this->reservedSize - this->size)-AL_INCREMENT))-this->reservedSize);
        this->reservedSize -= (((this->reservedSize - this->size)-AL_INCREMENT)-this->reservedSize);
        returnAux = 0;
    }
    return returnAux;
}
